...
#### Generate motions
```bash
python -m src.generate.generate_sequences /data1/zxy/ACTOR/exps/humanact12_categorical/checkpoint_4900.pth.tar  --num_samples_per_action 1 --cpu
```
...
#### Render motions
``` bash
python -m src.render.rendermotion /data1/zxy/ACTOR/exps/humanact12_categorical/generation.npy
```
