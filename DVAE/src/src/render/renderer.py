...
class Renderer:
    ...
    def render(self, img, verts, cam, angle=None, axis=None, mesh_filename=None, color= colorsys.hsv_to_rgb(1.0 , 1.0, 0.9)):
        ...
        # # 保存mesh
        # mesh.export("/data1/zxy/ACTOR/mesh/{}_{}.obj".format(key,action))
